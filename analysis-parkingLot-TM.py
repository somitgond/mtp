...
if __name__ == "__main__":
    ...
    for i in range(TCP_FLOW_START, TCP_FLOW_END+1):
        ...
        SOURCE_IPS.append(f"10.1.{30+i}.1")
        SOURCE_IPS.append(f"10.1.{60+i}.1")
    ...
    src_path = "results-parkingLot-TM-d1/"
    file_name_to_file_index = [
        ["results_parkingLot_LN_aqm_zc_150_to_300_mlBeta_TM", 0],
        # ["results_parkingLot_LN_codel_zc_150_to_300_mlBeta", 31],
        ["results_parkingLot_LN_naqm_150_to_300_mlBeta_TM", 31],
        ["results_parkingLot_LN_red_150_to_300_mlBeta_TM", 62],
    ]
    ...
    for fn, start_file_index in file_name_to_file_index:
        ...
        for i in range(start_file_index, start_file_index + step_size):
            ...
            file_name = f"{src_path}/result-parkingLot-TM-{i}"
