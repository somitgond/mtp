...
if __name__ == "__main__":
    ...
    src_path = "results-MLBeta/"
    file_name_to_file_index = [
        ["results_LN_aqm_zc_150_to_300_mlBeta", 0],
        ["results_LN_codel_zc_150_to_300_mlBeta", 31],
        ["results_LN_naqm_150_to_300_mlBeta", 62],
        ["results_LN_red_150_to_300_mlBeta", 93],
