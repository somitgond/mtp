...
%%%%%%%%%%%%%%%% Change %%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\ttitle}{Study of Congestion Control Algorithms in Packet-Switched Networks}
\newcommand{\supname}{Prof. Padmanabhan Rajan, Prof. Sreelakshmi} 
\newcommand{\degree}{B. Tech}
\newcommand{\authorname}{Somit Gond}
\newcommand{\rn}{B21138}
\newcommand{\univname}{IIT Mandi} 
